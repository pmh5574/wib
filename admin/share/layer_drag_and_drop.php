                    ...
                    <table class="table table-rows" id="tbl_add_goods" style="margin-bottom: 0px;width: 100%">
                        ...
                        if (is_array(gd_isset($data))) {
                            ...
                            foreach ($data as $key => $val) {
                                ...
                                <tr id="tbl_add_goods_<?php echo $val['goodsNo'];?>" data-goodsno="<?php echo $val['goodsNo'];?>" class="add_goods_free">
                                    <td class="center">
            ...
            <table cellpadding="0" cellpadding="0" width="100%">
                ...
                <td valign="top" class="goodsChoice_registeredTdArea" >
                    ...
                    <div id="goodsChoice_registerdOutlineDiv">
                        ...
                        <tbody id="goods_result" contents-length="<?=is_null($setGoodsList) ? 0 : strlen(trim($setGoodsList))?>">
