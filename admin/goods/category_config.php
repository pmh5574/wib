							...
							<div>
								<div class="notice-info">
									...
									<?=$info['cateTitle'];?>를 이미지로 노출하려면 아래 "<?=$info['cateTitle'];?> 이미지등록" 항목에 이미지를 등록하세요.
                                        ...
                                        <?php if($info['cateType'] == 'brand'){ ?>
                                        <tr>
                                            <th class="">한글 <?=$info['cateTitle'];?>명</th>
                                            <td colspan="3">
                                                <div>
                                                    <input type="text" name="cateKrNm" value="<?=$data['cateKrNm'];?>" class="form-control width-lg js-maxlength" maxlength="30"/>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php } ?>
