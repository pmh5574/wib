                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div class="form-inline">
                            ...
                            <input type="hidden" name="managerId" value="<?= $search['managerId']; ?>">
                            <input type="text" name="scmNmSearch" class="form-control width-lg" value="<?= $search['scmNoNm'][0]; ?>" placeholder="공급사 명을 입력해주세요.">
