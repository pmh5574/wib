...
<script type="text/javascript" xmlns="http://www.w3.org/1999/html">
    ...
    function add_option(){
        ...
        popup_goods_option_register = window.open('../goods/goods_register_option.php?'+postFix, 'popup_goods_option_register', 'width='+screen.width+', height='+screen.height+', scrollbars=yes, resizable=yes');
        /*var parameters = {
            'goodsNo' : '66898'
        };
    ...
    function image_storage_selector(storageName) {
        ...
        $('.imageStorageText').html($('#imageStorage option:selected').text());
        if (storageName !='url') {
            $.post("../goods/goods_ps.php", {mode: "getStorage", storage: storageName})
                .done(function (data) {
    ...
    function setScmInfo(commissionFl) {
        ...
        //추가상품그룹
        $.post('../goods/add_goods_ps.php', {'mode': 'search_scm', 'scmNo': scmNo}, function (data) {
            if(data) {
...
<form id="frmGoods" name="frmGoods" action="../goods/goods_ps.php" method="post" enctype="multipart/form-data">
    ...
    <div class="table-title gd-help-manual">
        카테고리 연결
        <span class="notice-info">카테고리가 먼저 등록되어 있어야 카테고리 연결이 가능합니다. <?php if (gd_is_provider() === false) { ?><a href="../goods/category_tree.php" class="btn btn-link-red" target="_blank">카테고리 등록하기 &gt;</a><?php } ?></span>
        ...
        <table class="table table-cols">
            ...
            <tr>
                ...
                <td class="input_area">
                    ...
                    <?php if (gd_is_provider() === false) { ?>
                        <a href="../goods/category_tree.php?cateType=brand" target="_blank" class="btn btn-sm btn-white btn-icon-plus">브랜드 추가</a><?php } ?>
